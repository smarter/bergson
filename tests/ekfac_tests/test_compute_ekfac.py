...
def ekfac_config(test_dir, ground_truth_path, world_size, overwrite, run_path):
    """Setup EKFAC configuration and run computation if needed."""
    ...
    cfg.debug = True
    cfg.fsdp = False  # Don't use FSDP for small models
    ...
    if not os.path.exists(run_path) or overwrite:
        ...
        print("EKFAC computation completed.")
    else:
        print("Using existing EKFAC results.")
...
def test_activation_covariances(run_path, ground_truth_path, ekfac_config):
    ...
    print("\nTesting activation covariances...")
    test_covariances(
        run_path=run_path,
...
def test_activation_eigenvectors(run_path, ground_truth_path, ekfac_config):
    ...
    """
    print("\nTesting activation eigenvectors...")
    test_eigenvectors(
        run_path=run_path,
        ground_truth_path=ground_truth_path,
